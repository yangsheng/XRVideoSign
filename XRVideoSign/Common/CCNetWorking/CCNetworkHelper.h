...
/** 请求成功的Block */
typedef void(^CCHttpRequestSuccess)(id responseObject);

/** 请求失败的Block */
typedef void(^CCHttpRequestFailed)(NSError *error);

/** 缓存的Block */
typedef void(^CCHttpRequestCache)(id responseCache);

/** 上传或者下载的进度, Progress.completedUnitCount:当前大小 - Progress.totalUnitCount:总大小*/
typedef void (^CCHttpProgress)(NSProgress *progress);
